        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(!name.getText().toString().equals("") && !lastName.getText().toString().equals("") && !phoneNumber.getText().toString().equals("") && !address.getText().toString().equals("")){
                    ...
                    Toast.makeText(ContactDetailsActivity.this,"Record updated",Toast.LENGTH_SHORT).show();
                    finish();

                }

                else {
                    Toast.makeText(ContactDetailsActivity.this,"All details are mandatory",Toast.LENGTH_SHORT).show();
                }
            }
        });
            ...
            public void onClick(View view) {
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        Toast.makeText(ContactDetailsActivity.this," Record deleted",Toast.LENGTH_SHORT).show();
                        finish();
                    }
                });
